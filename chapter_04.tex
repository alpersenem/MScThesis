...
\begin{figure}[h]
	...
	\label{method1}
\end{figure}
The first method is to extract the statistical properties of the current data in the time domain and to diagnose faults with machine learning techniques over them. Statistical features such as kurtosis, skewness, mean, RMS, standard deviation and median are extracted in the Knime tool for cases where the motor is healthy or faulty. 
