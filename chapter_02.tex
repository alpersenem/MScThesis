...
\begin{figure}[h]
	...
	% sekil3.eps: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=14 14 1155 740
	\caption{(a) Torque–speed curve for different voltages in line-start operation and (b) torque–speed curve for different voltages and frequencies in VFD-fed operation, adapted from \cite{faiz2017fault}.}	
	\label{vfd}
\end{figure}
